"""Clean Code in Python - Chater 5: Decorators
...
from decorator_function_1 import ControlledException, OperationObject, RunWithFailure
...
class RetryDecoratorTest(TestCase):
    ...
    def test_doc(self):
        self.assertEqual(run_operation.__doc__, "Run the operation in the task")
