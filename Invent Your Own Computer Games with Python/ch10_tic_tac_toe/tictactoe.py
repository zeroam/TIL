...
def isWinner(bo, le):
  ...
  # We us "bo" instead of "board" and "le" instead of "letter" so we don't have to type as much
  return (
...
def isSpaceFree(board, move):
  # Return True if the passwd move is free on the passed board.
  return board[move] == ' '
...
def isBoardFull(board):
  # Return True if every space on the board been taken. Otherwise, return False
  for i in range(1, 10):
    if isSpaceFree(board, i):
      return False
  return True
