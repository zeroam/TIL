"""Clean Code in Python - Chapter 5: Decorator
...
class OperationObject:
    ...
    def run(self) -> int:
        """Base operation for particular action"""
...
class RunWithFailure:
    ...
    def run(self):
        ...
        if self._time_failed < self._fail_n_times:
            self._time_failed += 1
...
class RetryDecoratorTest(TestCase):
    ...
    def test_fail_less_than_retry_limit(self):
        ...
        times_run = run_operator(failing_task)
