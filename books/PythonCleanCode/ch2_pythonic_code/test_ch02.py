...
class TestCaveats(unittest.TestCase):
    def test_bad_list(self):
        ...
        self.assertEqual(b1[0], '[even] 0')
        self.assertEqual(b1[3], '[odd] 3')
        self.assertRaises(TypeError, str.join, b1)
...
class TestIterables(unittest.TestCase):
    ...
    def _base_test_data_range(self, range_cls):
    ...
    def test_date_range(self):
        for range_cls in (
            ...
            with self.subTest(type_=range_cls.__name__):
                self._base_test_data_range(range_cls)
...
class TestDynamic(unittest.TestCase):
    def test_dynamic_attributes(self):
        ...
        with self.assertRaisesRegex(AttributeError, r".* has no attribute \S+"):
